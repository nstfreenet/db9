...
http://www.webmin.com/jcameron-key.asc | apt-key add jcameron-key.asc
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/GanzKurosaki/install/master/badvpn-udpgw64"
